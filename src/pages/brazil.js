            ...
            <Card>
              <div className="row">
                ...
                <div className="col-md-4 col-xs-12 with-responsive-top-spacing">
                  <h2 style={{ marginBottom: 20 }}>Estados</h2>
        ...
        <div className="row with-top-spacing">
            ...
            <Card cta>
              <div className="row cta">
                <div className="col-md-4">
                  <img src={world} className="cta--image" alt="Situação no Mundo" />
                </div>
          ...
          <div className="col-md-6">
            <Card cta>
              <div className="row cta">
                <div className="col-md-4">
                  <img src={donate} className="cta--image" alt="Faça o Bem" />
                </div>
